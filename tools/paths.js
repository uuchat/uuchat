...
module.exports = {
    ...
    appWebview: resolveApp('src/client/views/customer/chatWebview.html'),
    appWebviewCss: resolveApp('src/client/static/css/appview.css'),
    appWebviewJs: resolveApp('src/client/views/customer/webview.js'),
    appWebviewSocket: resolveApp('src/client/views/customer/socket.io-2.0.3.min.js'),
